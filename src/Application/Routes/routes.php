...
Route::get('genres',[MediaGenreController::class,'listGenres']);
Route::get('languages',[LanguageController::class,'fetch']);
Route::get('licences',[LicenseController::class,'fetch']);
Route::get('platforms',[PlatformsController::class,'listPlatforms']);
Route::get('media-types',[MediaTypeController::class,'listTypes']);
Route::get('media-genres',[MediaGenreController::class,'listGenres']);
Route::get('resources-types',[ResourceTypesController::class,'listResourceTypes']);
Route::get('resources/{resourceId}',[ResourceController::class,'findForView']);
Route::get('resources/{resourceId}/versions/{versionId}/download',[VersionController::class,'dowloadVersion']);
Route::get('resources',[ResourceController::class,'listResources']);
Route::get('resources/{resourceId}/comments',[CommentController::class,'listComments']);
Route::post('resources/{resourceId}/comments',[CommentController::class,'create']);
...
Route::middleware(['jwt.auth'])->group(function () {    
    ...
    Route::prefix('admin')->group(function () {
        ...
        Route::get('available-areas',[ResourceAreaController::class,'fetchForView']);
        Route::get('available-licenses',[LicenseController::class,'listLicenses']);
        Route::get('available-platforms',[PlatformsController::class,'listPlatforms']);
        Route::get('available-devices',[DeviceController::class,'listDevices']);
        Route::get('available-languages',[LanguageController::class,'listLanguages']);
        Route::get('menus',[MenuController::class,'fetchPermission']);
        Route::get('permissions',[PermissionController::class,'fetchPermissions']);
        Route::get('resources-types',[ResourceTypesController::class,'listResourceTypes']);
        Route::get('resources-states',[ResourceStateController::class,'fetchResourceStates']);
        Route::get('available-roles',[RolController::class,'fetchForView']);
        Route::get('available-userstates',[UserStateController::class,'fetchUserStates']);
        ...
        Route::prefix('roles')->group(function () {
            ...
            Route::get('/summary',[RolController::class,'rolesSummary'])->middleware('permission:can.list.roles');
        ...
        Route::prefix('devices')->group(function () {
            ...
            Route::get('/summary',[DeviceController::class,'fetchSummary'])->middleware('permission:can.list.devices');
        ...
        Route::prefix('platforms')->group(function () {
            ...
            Route::get('/summary',[PlatformsController::class,'fetchSummary'])->middleware('permission:can.list.platforms');
        ...
        Route::prefix('licenses')->group(function () {
            ...
            Route::get('/summary',[LicenseController::class,'fetchSummary'])->middleware('permission:can.search.licenses');
        ...
        Route::prefix('resources')->group(function () {
            ...
            Route::get('/{resourceId}/versions/{versionId}/download',[VersionController::class,'donwloadVersionFile']);
        ...
        Route::prefix('users')->group(function () {
            Route::get('/summary',[UserController::class,'usersSummary'])->middleware('permission:can.search.users');
        ...
        Route::prefix('resource-areas')->group(function () {
            ...
            Route::get('/summary',[ResourceAreaController::class,'areasSummary'])->middleware('permission:can.search.areas');
